...
function LLAMAworker(which) {
    var w
    if (typeof(Worker) !== "undefined") {
        if (typeof(w) == "undefined") {
            console.log('Starting LLaMa worker for: ' + which)
            w = new Worker("/bots/llama_worker.js")
            ...
            if (el) {
                ...
                console.log("Stopping LLaMa worker: missing HTML element")
                stopWorker(w)
            }
        }
            ...
            if (caption) { 
                if (caption != " ") {
                    ...
                    if (el) {      
                        ...
                        if (aCapt[1]) {
                            ...
                            if (emojis) {
                                ...
                                for (var i = 0; i < aEmo.length; i++) {
                                    emo = aEmo[i]
                                    tmp_tag = "LlamaEmoji_" + emo
                                    console.log("LLaMa Worker tagging image with: " + emo)
                        ...
                        var capt2 = "llama_" + caption.replace(/ /g,"-").replace("caption-","")
                        console.log("LLaMa Worker tagging image with: " + capt)
